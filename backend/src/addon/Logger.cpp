...
void Logger::LogStr(const std::string& str)
{
    // Narrow UTF8 string to wide UTF16 string
    const std::wstring wsMsg = std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>>().from_bytes(str);
    WriteLog(wsMsg);
}
